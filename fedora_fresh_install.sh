#!/bin/bash
programs="zsh vim vim-X11 atool gimp meld gitk firefox python-pip python3 python3-pip libreoffice vlc curl tmux dmenu acpi emacs ImageMagick java-1.8.0-openjdk mosh wine"
